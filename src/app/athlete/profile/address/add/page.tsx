...
export default function AddAddressPage() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      setTimeout(() => {
        router.push('/athlete/profile?tab=address');
      }, 1500);
    } catch (err: any) {
        ...
        <div className="bg-[#121212] rounded-3xl p-6 md:p-10 border border-white/5">
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <div className="pt-6 border-t border-white/5 flex gap-4">
              ...
              <Link href="/athlete/profile?tab=address" className="flex-1 bg-transparent border border-white/20 text-white font-bold py-4 rounded-xl hover:bg-white/5 transition-colors text-center text-sm">
                Cancel
              </Link>
            </div>
