      ...
      <div className="flex-1 space-y-12">
        ...
        <div className="space-y-8">
          ...
          <div className="glass-card border-white/5 p-8 flex items-center gap-8">
            <div className="w-24 h-24 rounded-full border-2 border-dashed border-white/20 flex items-center justify-center cursor-pointer hover:border-white/40 transition-all">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            <Input label="Full Name" placeholder="Maya Reyes" />
        ...
        <div className="flex gap-4 pt-12">
          <Button variant="outline" className="px-10 uppercase tracking-widest text-xs">Back</Button>
      ...
      <div className="w-full lg:w-80 sticky top-32">
        <div className="glass-card border-white/5 overflow-hidden">
          <div className="aspect-[3/4] relative bg-dark-400">
            ...
            {/* Overlay Info */}
            <div className="absolute inset-x-0 bottom-0 p-6 bg-gradient-to-t from-black to-transparent pt-20 text-center">
              <div className="w-20 h-20 rounded-full border-4 border-black mx-auto mb-4 overflow-hidden bg-dark-300">
                <Image src="/assets/athelete_auth.png" alt="Profile" width={80} height={80} className="object-cover opacity-50" />
              </div>
              <h3 className="text-xl font-bold tracking-tight uppercase mb-1">Your Name</h3>
              <p className="text-[10px] text-white/40 uppercase tracking-widest font-bold mb-4">@yourhandle • Lagos, NG</p>
